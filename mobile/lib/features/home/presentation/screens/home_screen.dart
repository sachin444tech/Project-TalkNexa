            ...
            SliverPadding(
              ...
              sliver: SliverList(
                delegate: SliverChildListDelegate([
                  const HomeHeader(userName: 'TalkNexa Learner'),
                  ...
                  SpeakingHeroCard(
                    onStartSpeaking: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => const AiPracticeSetupScreen(),
                        ),
                      );
                    },
                  ),
                    ...
                    children: [
                      Expanded(
                        child: PracticeOptionCard(
                          ...
                          title: 'AI Partner',
                          subtitle: 'Practice naturally with AI.',
                          gradient: const [
                            Color(0xFF2563EB),
                            Color(0xFF0EA5E9),
                          ],
                      ...
                      Expanded(
                        child: PracticeOptionCard(
                          ...
                          title: 'Live Rooms',
                          subtitle: 'Speak with real learners.',
                          gradient: const [
                            Color(0xFF7C3AED),
                            Color(0xFF8B5CF6),
                          ],
                          onTap: () {
                            _showComingSoon(context, 'Live Rooms');
                          },
                        ),
                      ),
                    ],
